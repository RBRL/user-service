...
//
//    @Test
//    public void shouldAllowAccessToUnsecureAPITest() throws Exception {
//        mvc.perform(MockMvcRequestBuilders.get("/user/home")).andExpect(status().isOk());
//    }
//
//    @Test
...
//
//    	
//        String token = jwtUtil.generateToken("user2");
//        assertNotNull(token);
